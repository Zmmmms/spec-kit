...
update_specific_agent() {
    ...
    bob)
        ...
        ;;
    coco)
        update_agent_file "$COCO_FILE" "Coco Agent-CLI"
        ;;
    *)
        log_error "Unknown agent type '$agent_type'"
        log_error "Expected: claude|gemini|copilot|cursor-agent|qwen|opencode|codex|windsurf|kilocode|auggie|roo|amp|shai|q|bob|coco"
        exit 1
        ;;
    esac
}
